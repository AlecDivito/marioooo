...
void Animation::setStartFrame(sf::Vector2i mFrameStart)
{
	mStartFrame = mFrameStart;
}

sf::Vector2i Animation::getStartFrame() const
{
	return mStartFrame;
}
...
{
	return sf::FloatRect(getPosition(), static_cast<sf::Vector2f>(getFrameSize()));
}
